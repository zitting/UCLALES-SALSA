...
CONTAINS
   ...
   SUBROUTINE inorganic_pdfite(rh,temp,ions,water_total,Press_HNO3,Press_HCl,Press_NH3,gamma_out,mols_out)
      ...
      henrys_temp_dep = (1/temp - 1/298)

      HCL_hno3 = 1.0; H2SO4_hno3 = 1.0; NH42SO4_hno3 = 1.0; NH4NO3_hno3 = 1.0; NH4Cl_hno3 = 1.0;
      Na2SO4_hno3 = 1.0; NaNO3_hno3 = 1.0; NaCl_hno3 = 1.0;
      HNO3_hcl = 1.0; H2SO4_hcl = 1.0; NH42SO4_hcl = 1.0; NH4NO3_hcl = 1.0; NH4Cl_hcl = 1.0;
      Na2SO4_hcl = 1.0; NaNO3_hcl = 1.0; NaCl_hcl = 1.0;
      HNO3_nh3 = 1.0; HCl_nh3 = 1.0; H2SO4_nh3 = 1.0; NH42SO4_nh3 = 1.0; NH4NO3_nh3 = 1.0;
      NH4Cl_nh3 = 1.0; Na2SO4_nh3 = 1.0; NaNO3_nh3 = 1.0; NaCl_nh3 = 1.0;
      HNO3_hhso4 = 1.0; HCL_hhso4 = 1.0; NH42SO4_hhso4 = 1.0; NH4NO3_hhso4 = 1.0; NH4Cl_hhso4 = 1.0;
      Na2SO4_hhso4 = 1.0; NaNO3_hhso4 = 1.0; NaCl_hhso4 = 1.0;
      HNO3_h2so4 = 1.0; HCl_h2so4 = 1.0; NH42SO4_h2so4 = 1.0; NH4NO3_h2so4 = 1.0; NH4Cl_h2so4 = 1.0;
      Na2SO4_h2so4 = 1.0; NaNO3_h2so4 = 1.0; NaCl_h2so4 = 1.0;
      !--new nh3 variables--
      HNO3_nh4hso4 = 1.0; HCL_nh4hso4 = 1.0; H2SO4_nh4hso4 = 1.0; NH42SO4_nh4hso4 = 1.0;
      NH4NO3_nh4hso4 = 1.0; NH4Cl_nh4hso4 = 1.0; Na2SO4_nh4hso4 = 1.0; NaNO3_nh4hso4 = 1.0; NaCl_nh4hso4 = 1.0;
      ...
      Press_HNO3 = 0.0
      Press_HCl  = 0.0
      Press_NH3  = 0.0                         !Initialising vapour pressure over the multicomponent
										                          !particle
	
      gamma_out = 1           ! i.e. don't alter the ideal mixing ratios if there's nothing there.
      ...
      charge_sum = ions(1)+ions(2)+ions(3)+2.0*ions(4)+ions(5)+ions(6)+ions(7)
      nitric_acid = 0.0;hydrochloric_acid = 0.0;sulphuric_acid = 0.0
      ammonium_sulphate = 0.0;ammonium_nitrate = 0.0;ammonium_chloride =0.0
      sodium_sulphate = 0.0;sodium_nitrate = 0.0;sodium_chloride = 0.0
      nitric_acid = (2.0*ions(1)*ions(6))/(charge_sum)
      hydrochloric_acid = (2.0*ions(1)*ions(7))/(charge_sum)
      sulphuric_acid = (2.0*ions(1)*ions(4))/(charge_sum)
      ammonium_sulphate = (2.0*ions(2)*ions(4))/(charge_sum)
      ammonium_nitrate = (2.0*ions(2)*ions(6))/(charge_sum)
      ammonium_chloride = (2.0*ions(2)*ions(7))/(charge_sum)
      sodium_sulphate = (2.0*ions(3)*ions(4))/(charge_sum)
      sodium_nitrate = (2.0*ions(3)*ions(6))/(charge_sum)
      sodium_chloride = (2.0*ions(3)*ions(7))/(charge_sum)

         ! b) - Inorganic equivalent fractions

      solutes = 0.0
      solutes = 3.0*sulphuric_acid+2.0*hydrochloric_acid+2.0*nitric_acid+3.0*ammonium_sulphate+&
         2.0*ammonium_nitrate+2.0*ammonium_chloride+3.0*sodium_sulphate+2.0*sodium_nitrate+&
         2.0*sodium_chloride

      nitric_acid_eq_frac = 2.0*nitric_acid/(solutes)
      hydrochloric_acid_eq_frac = 2.0*hydrochloric_acid/(solutes)
      sulphuric_acid_eq_frac = 3.0*sulphuric_acid/(solutes)
      ammonium_sulphate_eq_frac = 3.0*ammonium_sulphate/(solutes)
      ammonium_nitrate_eq_frac = 2.0*ammonium_nitrate/(solutes)
      ammonium_chloride_eq_frac = 2.0*ammonium_chloride/(solutes)
      sodium_sulphate_eq_frac = 3.0*sodium_sulphate/(solutes)
      sodium_nitrate_eq_frac = 2.0*sodium_nitrate/(solutes)
      sodium_chloride_eq_frac = 2.0*sodium_chloride/(solutes)
