...
CONTAINS
   ...
   SUBROUTINE sedim_SALSA(n1,n2,n3,n4,tstep,tk,th,          &
      ...
      REAL :: prnt(n1,n2,n3,nprc), prvt(n1,n2,n3,n4*nprc)     ! Rain number and mass tendencies due to fallou
      ...
      IF (sed_aero) THEN
         ...
         CALL DepositionSlow(n1,n2,n3,n4,nbins,tk,a_dn%data,1500.,ustar,naerop,maerop,dzt,nlim,andiv,amdiv,andep,remaer,1)
      ...
      IF (sed_cloud) THEN
         ...
         CALL DepositionSlow(n1,n2,n3,n4,ncld,tk,a_dn%data,rhowa,ustar,ncloudp,mcloudp,dzt,nlim,cndiv,cmdiv,cndep,remcld,2)
      ...
      IF (sed_ice) THEN
         ...
         CALL DepositionSlow(n1,n2,n3,n4,nice,tk,a_dn%data,rhoic,ustar,nicep,micep,dzt,nlim,indiv,imdiv,indep,remice,4)
      ...
      IF (sed_precp) THEN
         ...
         CALL DepositionFast(n1,n2,n3,n4,nprc,tk,a_dn%data,rowt,nprecpp,mprecpp,tstep,dzt,prnt,prvt,remprc,prlim,rrate,3)
      ...
      IF (sed_snow) THEN
         ...
         CALL DepositionFast(n1,n2,n3,n4,nsnw,tk,a_dn%data,rowt,nsnowp,msnowp,tstep,dzt,srnt,srvt,remsnw,prlim,srate,5)
   ...
   SUBROUTINE DepositionFast(n1,n2,n3,n4,nn,tk,adn,pdn,numc,mass,tstep,dzt,prnt,prvt,remprc,clim,rate,flag)
      ...
      REAL :: prnchg(n1,nn), prvchg(n1,nn,n4) ! Instantaneous changes in precipitation number and mass
