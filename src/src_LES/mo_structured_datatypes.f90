MODULE mo_structured_datatypes
  ...
  ! the first, the type-bound pointer "data" points to memory
  ...
  TYPE FloatArray1d
     REAL, POINTER :: data(:) => NULL() ! This is used as the generic access name for the data 
  ...
  FUNCTION FloatArray1d_constructor(trgt,store)
    ...
    IF (PRESENT(store)) THEN
       IF (.NOT. store) THEN
          FloatArray1d_constructor%data => trgt
       ELSE
  ...
  FUNCTION FloatArray2d_constructor(trgt,store)
    ...
    IF (PRESENT(store)) THEN
       IF (.NOT. store) THEN
          FloatArray2d_constructor%data => trgt
       ELSE
          present_and_true = .TRUE.
       END IF
    END IF
    ...
    IF ( .NOT. PRESENT(store) .OR. present_and_true ) THEN
          ...
          ! Associate "data" with the allocated array 
          FloatArray2d_constructor%data => FloatArray2d_constructor%alloc          
     END IF
  ...
  FUNCTION FloatArray3d_constructor(trgt,store)
    ...
    IF (PRESENT(store)) THEN
       IF (.NOT. store) THEN
          FloatArray3d_constructor%data => trgt
       ELSE
          present_and_true = .TRUE.
       END IF
    END IF
    ...
    IF ( .NOT. PRESENT(store) .OR. present_and_true ) THEN
          ...
          ! Associate "data" with the allocated array 
          FloatArray3d_constructor%data => FloatArray3d_constructor%alloc          
     END IF
  ...
  FUNCTION FloatArray4d_constructor(trgt,store)
    ...
    IF (PRESENT(store)) THEN
       IF (.NOT. store) THEN
          FloatArray4d_constructor%data => trgt
       ELSE
          present_and_true = .TRUE.
       END IF
    END IF
    ...
    IF ( .NOT. PRESENT(store) .OR. present_and_true ) THEN
          ...
          ! Associate "data" with the allocated array 
          FloatArray4d_constructor%data => FloatArray4d_constructor%alloc          
     END IF
